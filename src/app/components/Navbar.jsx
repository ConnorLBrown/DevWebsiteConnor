        ...
        <div className="flex items-center justify-between py-2 lg:py-4 font-Lato"> {/* Apply font here */}
          <div className="mobile-menu block md:hidden">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-black text-sm">Web Profile</p>
              </div>
            </div>
            <button
              onClick={() => setNavbarOpen(!navbarOpen)}
              className="flex items-center px-3 py-2 border rounded border-slate-200 text-slate-200 hover:text-stone-300 hover:border-black"
            >
              {navbarOpen ? (
