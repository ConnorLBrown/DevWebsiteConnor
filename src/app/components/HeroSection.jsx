  ...
  return (
    <section className="bg-white lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="capitalize text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-secondary-600 font-sans mb-4 text-5xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
